...
public:
    ...
    /**
     * @brief Copies the content of the back buffer to the specified destination vector.
     *
     * @param dest The destination vector to copy the back buffer content to.
     */
    void copyBackBuffer(std::vector<int> &dest) const;
