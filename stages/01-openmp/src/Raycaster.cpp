...
{
    /*
        rayDir0 and rayDir1 declare outside can lead to data race since they are shared between threads.
        thus Several threads will write to it at the same time
    */
...
#pragma omp parallel for
    ...
    {
        /* here, each thread has its own local variables. */
